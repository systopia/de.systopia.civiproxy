...
// Make CRM_Civiproxy_ExtensionUtil available.
require_once __DIR__ . '/../../civiproxy.civix.php';

// phpcs:disable PSR1.Files.SideEffects

// Add test classes to class loader.
addExtensionDirToClassLoader(__DIR__);
addExtensionToClassLoader('de.systopia.civiproxy');
 ...
 */
function _civiproxy_test_civicrm_container(ContainerBuilder $container): void {
}
